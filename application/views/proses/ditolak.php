                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Semua Proses Lamaran Kerja Yang Ditolak</h3>
                            </div>
                            <div class="card-body">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Detail Data Proses Lamaran Kerja Yang Ditolak</h4>
